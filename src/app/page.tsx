...
import { Trophy, Zap, Users, Star, TrendingUp, ArrowRight, Medal, Flame } from 'lucide-react'
    ...
    <div className="min-h-screen bg-white text-gray-900 overflow-x-hidden">
      ...
      <nav className="fixed top-0 left-0 right-0 z-50 bg-white/80 backdrop-blur-xl border-b border-gray-100 px-6 py-4">
        <div className="max-w-6xl mx-auto flex items-center justify-between">
          <div className="flex items-center gap-2.5">
            ...
            <span className="font-bold text-lg tracking-tight">EduArena</span>
          </div>
      ...
      <section className="pt-32 pb-24 px-6 relative">
        ...
        <div className="relative max-w-5xl mx-auto text-center">
          ...
          {/* Stats */}
          <div className="inline-flex items-center gap-8 bg-gray-50 border border-gray-200 rounded-2xl px-8 py-4">
            {[
      ...
      <section id="features" className="py-24 px-6 bg-gray-950 text-white">
        <div className="max-w-6xl mx-auto">
          <div className="text-center mb-16">
            ...
            <h2 className="text-4xl font-black">Oddiy o'qishdan farqli</h2>
            ...
            {[
              {
                ...
                desc: 'Har kuni 5 ta yangi savol. Streak saqlang, ball to\'plang, oldinga boring.',
                tag: 'Har kuni',
              },
              {
              ...
              },
              {
                ...
                title: 'Streak tizimi',
                desc: 'Har kuni qatnashing. Ketma-ket kunlar ko\'paygan sari mukofot ortadi.',
                tag: 'Motivatsiya',
              },
            ].map((f, i) => (
              <div key={i} className="bg-white/5 hover:bg-white/8 border border-white/10 rounded-2xl p-6 transition group">
      ...
      <section id="ranking" className="py-24 px-6">
        <div className="max-w-4xl mx-auto">
          <div className="text-center mb-16">
            ...
            <h2 className="text-4xl font-black">Eng yaxshilar shu yerda</h2>
          ...
          <div className="flex items-end justify-center gap-6 mb-8">
            {[
              { place: 2, name: 'Sardor M.', score: 890, height: 'h-28', bg: 'bg-gray-100', text: 'text-gray-600', medal: '🥈' },
              { place: 1, name: 'Kamola R.', score: 1240, height: 'h-36', bg: 'bg-violet-600', text: 'text-white', medal: '👑' },
              { place: 3, name: 'Jasur T.', score: 760, height: 'h-24', bg: 'bg-amber-100', text: 'text-amber-700', medal: '🥉' },
            ].map((p) => (
              <div key={p.place} className="flex flex-col items-center gap-3">
                <span className="text-2xl">{p.medal}</span>
                <div className="w-14 h-14 rounded-full bg-gray-100 border-2 border-gray-200 flex items-center justify-center font-black text-gray-600 text-lg">
                  {p.name.charAt(0)}
                </div>
                <div className="text-center">
                  <p className="font-bold text-sm">{p.name}</p>
                  <p className="text-xs text-gray-400">{p.score} ball</p>
                </div>
                <div className={`w-24 ${p.height} ${p.bg} rounded-t-2xl flex items-center justify-center`}>
                  <span className={`font-black text-2xl ${p.text}`}>#{p.place}</span>
                </div>
              </div>
            ))}
          </div>
      ...
      <section className="py-24 px-6 bg-violet-600">
        <div className="max-w-3xl mx-auto text-center">
          ...
          <Link
            href="/register"
            className="inline-flex items-center gap-2 bg-white text-violet-700 font-black px-10 py-4 rounded-2xl text-lg hover:bg-violet-50 transition shadow-xl"
          >
            Hoziroq qo'shiling
            <ArrowRight className="w-5 h-5" />
          </Link>
